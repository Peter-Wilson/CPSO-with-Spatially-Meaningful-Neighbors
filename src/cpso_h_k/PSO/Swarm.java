...
public class Swarm
    {
        ...
        public void UpdateVelocity(cpso_h_k.Particle p)
        {
        ...
        //Update the velocity of the points based on the velocity solution
        public void UpdateVelocity(cpso_h_k.Particle p, boolean test)
        {
        ...
        public void UpdatePosition(cpso_h_k.Particle p)
        {
            for(int i = 0; i < k; i++)
            {
