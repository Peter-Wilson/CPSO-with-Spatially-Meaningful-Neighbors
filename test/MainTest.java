...
public class MainTest {
    ...
    public void testCPSOHK() {
        ...
        int dimensionSize = 6;
        CPSO_H_k cpso = new CPSO_H_k(dimensionSize, 200, 20, 0.5, 0.3, 0.2,2,false);
        //cpso.start();
    }
    ...
    public void testCPSORK() {
        ...
        int dimensionSize = 6;
        CPSO_R_k cpso = new CPSO_R_k(dimensionSize, 200, 20, 0.5, 0.3, 0.2,2,false);
        //cpso.start();
    }
    ...
    public void testCPSOS() {
        ...
        int dimensionSize = 5;
        CPSO_S cpso = new CPSO_S(dimensionSize, 200, 20, 0.5, 0.3, 0.2, dimensionSize, false);
        //cpso.start();
    }
